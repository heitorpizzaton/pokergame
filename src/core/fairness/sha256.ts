/**
 * SHA-256 (FIPS 180-4), synchronous so the commitment exists before the hand is shown. Checked
 * against the NIST test vectors and the platform's WebCrypto in the tests.
 */
